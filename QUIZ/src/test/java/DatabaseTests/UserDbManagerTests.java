...
public class UserDbManagerTests {
    ...
    @Test
    public void testGetUsersGetFriends() throws SQLException {
        ...
        ArrayList<String> friendsList = db.getFriendsList("Bacha");
        assertEquals(5, friendsList.size());
        assertEquals("almasxit", friendsList.get(0));
        assertEquals("kingslayer", friendsList.get(1));
        assertEquals("user1", friendsList.get(2));
        assertEquals("user4", friendsList.get(3));
        assertEquals("user9", friendsList.get(4));
    }
